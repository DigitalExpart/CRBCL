...
class Provider(Base, TimestampMixin):
    ...
    )  # Physician, Therapist, Counsellor, Dentist, Cultural Service, etc.
    ...
    locations: Mapped[list[ProviderLocation]] = relationship(
        "ProviderLocation", back_populates="provider", lazy="selectin"
    )
    specialties: Mapped[list[ProviderSpecialty]] = relationship(
        "ProviderSpecialty", back_populates="provider", lazy="selectin"
    )
