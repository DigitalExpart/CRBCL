...
PERMISSIONS_DATA = [
    ...
    # Resource Unit & Recruitment (Sprint 1 & 2)
    ...
    {"key": Permissions.CAREGIVER_TRAINING_READ, "name": "Read Caregiver Training Records", "category": "resource_unit"},
    {"key": Permissions.CAREGIVER_TRAINING_WRITE, "name": "Record Caregiver Training Completion", "category": "resource_unit"},
    {"key": Permissions.CAREGIVER_TRAINING_VERIFY, "name": "Verify Caregiver Training & Certifications", "category": "resource_unit"},
    {"key": Permissions.RESOURCE_CLEARANCE_ADJUDICATE, "name": "Adjudicate Resource Caregiver Clearances", "category": "resource_unit"},
    {"key": Permissions.PLACEMENT_HOME_INSPECTION_MANAGE, "name": "Manage Inspections, Deficiencies & Corrective Actions", "category": "placement_homes"},
    {"key": Permissions.RESOURCE_MATCHING_READ, "name": "Access Placement Matching Decision Support", "category": "resource_unit"},
    {"key": Permissions.RESOURCE_MONITORING_READ, "name": "Read Resource Home Monitoring Visits", "category": "resource_unit"},
    {"key": Permissions.RESOURCE_MONITORING_MANAGE, "name": "Record Resource Home Monitoring Visits", "category": "resource_unit"},
    {"key": Permissions.RESOURCE_COMPLAINT_READ, "name": "Read Resource Complaints (Basic)", "category": "resource_unit"},
    {"key": Permissions.RESOURCE_COMPLAINT_SENSITIVE_READ, "name": "Read Sensitive Resource Complaint Details & Findings", "category": "resource_unit"},
    {"key": Permissions.RESOURCE_COMPLAINT_MANAGE, "name": "Manage Complaint Investigations & Findings", "category": "resource_unit"},
    {"key": Permissions.RESOURCE_COMPLAINT_DISPOSITION, "name": "Determine Complaint Disposition & Closure", "category": "resource_unit"},
    {"key": Permissions.CAREGIVER_SUPPORT_READ, "name": "Read Caregiver Supports", "category": "resource_unit"},
    {"key": Permissions.CAREGIVER_SUPPORT_MANAGE, "name": "Manage Caregiver Support Requests", "category": "resource_unit"},
    {"key": Permissions.RESOURCE_REPORTING_READ, "name": "Read Resource Unit Reports", "category": "resource_unit"},
    {"key": Permissions.RESOURCE_REPORTING_EXPORT, "name": "Export Resource Unit Reports", "category": "resource_unit"},
    {"key": Permissions.RESOURCE_OUTCOMES_READ, "name": "View Strategic Resource Outcomes", "category": "resource_unit"},
    # Documents
...
ROLE_PERMISSIONS_MAP = {
    ...
    "resource_worker": [
        ...
        Permissions.BACKGROUND_CHECK_READ,
        Permissions.BACKGROUND_CHECK_WRITE,
        Permissions.CAREGIVER_TRAINING_READ,
        Permissions.CAREGIVER_TRAINING_WRITE,
        Permissions.PLACEMENT_HOME_LICENSE_READ,
        Permissions.RESOURCE_MATCHING_READ,
        Permissions.RESOURCE_MONITORING_READ,
        Permissions.RESOURCE_MONITORING_MANAGE,
        Permissions.RESOURCE_COMPLAINT_READ,
        Permissions.RESOURCE_COMPLAINT_MANAGE,
        Permissions.CAREGIVER_SUPPORT_READ,
        Permissions.CAREGIVER_SUPPORT_MANAGE,
        Permissions.RESOURCE_REPORTING_READ,
        Permissions.RESOURCE_OUTCOMES_READ,
        Permissions.DOCUMENT_READ,
        Permissions.DOCUMENT_UPLOAD,
        Permissions.TIMELINE_READ,
    ],
    "resource_supervisor": [
        ...
        Permissions.BACKGROUND_CHECK_READ,
        Permissions.BACKGROUND_CHECK_WRITE,
        Permissions.RESOURCE_CLEARANCE_ADJUDICATE,
        Permissions.CAREGIVER_TRAINING_READ,
        Permissions.CAREGIVER_TRAINING_WRITE,
        Permissions.CAREGIVER_TRAINING_VERIFY,
        Permissions.PLACEMENT_HOME_LICENSE_READ,
        Permissions.PLACEMENT_HOME_LICENSE_MANAGE,
        Permissions.PLACEMENT_HOME_INSPECTION_MANAGE,
        Permissions.RESOURCE_MATCHING_READ,
        Permissions.RESOURCE_MONITORING_READ,
        Permissions.RESOURCE_MONITORING_MANAGE,
        Permissions.RESOURCE_COMPLAINT_READ,
        ...
        Permissions.CAREGIVER_SUPPORT_MANAGE,
        Permissions.RESOURCE_REPORTING_READ,
        Permissions.RESOURCE_REPORTING_EXPORT,
        Permissions.RESOURCE_OUTCOMES_READ,
        Permissions.DOCUMENT_READ,
        Permissions.DOCUMENT_UPLOAD,
        Permissions.TIMELINE_READ,
...
async def seed_assessment_templates(db: AsyncSession) -> None:
    ...
    templates_spec = [
        ...
        {
            "key": "CAREGIVER_HOME_ASSESSMENT",
            "name": "Caregiver & Home Study Assessment",
            "description": "Comprehensive Resource Unit evaluation covering caregiver interviews, home study, cultural assessment, parenting capacity, support network, strengths, concerns, and recommendation/outcome.",
            "category": "resource_unit",
            "sections": [
                {
                    "key": "caregiver_interviews",
                    "title": "1. Caregiver Interviews & Background",
                    "sort_order": 1,
                    "is_required": True,
                    "questions": [
                        {
                            "key": "caregiver_motivation",
                            "label": "Caregiver motivation and commitment to fostering or kinship care:",
                            "question_type": "LONG_TEXT",
                            "is_required": True,
                            "sort_order": 1,
                        },
                        {
                            "key": "caregiver_background_history",
                            "label": "Caregiver personal background, life history, and relationship dynamics:",
                            "question_type": "LONG_TEXT",
                            "is_required": True,
                            "sort_order": 2,
                        },
                ...
                {
                    "key": "home_study",
                    "title": "2. Home Study & Physical Safety",
                    "sort_order": 2,
                    "is_required": True,
                    "questions": [
                        {
                            "key": "bedroom_spaces_adequate",
                            "label": "Adequate and safe bedroom space available for children:",
                            "question_type": "BOOLEAN",
                            "is_required": True,
                            "sort_order": 1,
                        },
                        {
                            "key": "home_safety_standards_met",
                            "label": "Fire safety, smoke alarms, emergency exits, and firearm/medication storage verified:",
                            "question_type": "BOOLEAN",
                            "is_required": True,
                            "sort_order": 2,
                        },
                        {
                            ...
                            "label": "Description of physical residence, yard, neighborhood, and physical safety:",
                            "question_type": "LONG_TEXT",
                            "is_required": True,
                            "sort_order": 3,
                        },
                ...
                {
                    "key": "cultural_assessment",
                    "title": "3. Cultural Assessment & Connection",
                    "sort_order": 3,
                    "is_required": True,
                    "questions": [
                        {
                            "key": "indigenous_cultural_connection",
                            "label": "Knowledge of child's First Nation, cultural traditions, and customs:",
                            "question_type": "LONG_TEXT",
                            "is_required": True,
                            "sort_order": 1,
                        },
                        {
                            "key": "commitment_to_cultural_continuity",
                            "label": "Caregiver commits to supporting cultural continuity, community ceremonies, and language:",
                            "question_type": "BOOLEAN",
                            "is_required": True,
                            "sort_order": 2,
                        },
                ...
                {
                    "key": "parenting_capacity",
                    "title": "4. Parenting Capacity & Child Needs",
                    "sort_order": 4,
                    "is_required": True,
                    "questions": [
                        {
                            "key": "trauma_informed_parenting",
                            "label": "Understanding of trauma-informed care and non-physical redirection/discipline:",
                            "question_type": "LONG_TEXT",
                            "is_required": True,
                            "sort_order": 1,
                        },
                        {
                            "key": "meeting_developmental_needs",
                            "label": "Demonstrated ability to meet medical, emotional, and educational developmental needs:",
                            "question_type": "LONG_TEXT",
                            "is_required": True,
                            "sort_order": 2,
                        },
                ...
                {
                    "key": "support_network",
                    "title": "5. Support Network & Community Resources",
                    "sort_order": 5,
                    "is_required": True,
                    "questions": [
                        {
                            "key": "extended_support_network",
                            "label": "Identified extended family, friends, and community respite supports:",
                            "question_type": "LONG_TEXT",
                            "is_required": True,
                            "sort_order": 1,
                        },
                ...
                {
                    "key": "strengths",
                    "title": "6. Identified Caregiver Strengths",
                    "sort_order": 6,
                    "is_required": True,
                    "questions": [
                        {
                            "key": "identified_caregiver_strengths",
                            "label": "Summary of caregiver strengths, protective capacities, and resilience:",
                            "question_type": "LONG_TEXT",
                            "is_required": True,
                            "sort_order": 1,
                        },
                ...
                {
                    "key": "concerns",
                    "title": "7. Identified Concerns & Risk Mitigations",
                    "sort_order": 7,
                    "is_required": True,
                    "questions": [
                        {
                            "key": "identified_vulnerabilities_concerns",
                            "label": "Any potential concerns, vulnerabilities, or required safety conditions:",
                            "question_type": "LONG_TEXT",
                            "is_required": False,
                            "sort_order": 1,
                        },
                ...
                {
                    "key": "recommendation_outcome",
                    "title": "8. Recommendation & Outcome",
                    "sort_order": 8,
                    "is_required": True,
                    "questions": [
                        {
                            "key": "caregiver_recommendation_outcome",
                            "label": "Assessment Recommendation:",
                            "question_type": "SINGLE_SELECT",
                            "is_required": True,
                            "sort_order": 1,
                            "options": [
                                {"key": "RECOMMEND_APPROVAL", "label": "Recommend Full Approval", "sort_order": 1},
                                {"key": "RECOMMEND_CONDITIONAL", "label": "Recommend Conditional Approval (Mitigations Required)", "sort_order": 2},
                                {"key": "DEFER", "label": "Defer Recommendation Pending Further Study", "sort_order": 3},
                                {"key": "DECLINE", "label": "Recommend Decline", "sort_order": 4},
                            ],
                        },
                        {
                            "key": "recommended_capacity_limit",
                            "label": "Recommended placement bed capacity:",
                            "question_type": "NUMBER",
                            "is_required": True,
                            "sort_order": 2,
                        },
                        {
                            "key": "assessment_outcome_rationale",
                            "label": "Worker assessment summary and recommendation rationale:",
                            "question_type": "LONG_TEXT",
                            "is_required": True,
                            "sort_order": 3,
                        },
