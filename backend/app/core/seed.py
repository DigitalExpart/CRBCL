...
PERMISSIONS_DATA = [
    ...
    {"key": Permissions.CALENDAR_READ_OWN, "name": "Read Own Calendar", "category": "calendar"},
    {"key": Permissions.CALENDAR_READ_TEAM, "name": "Read Team Calendar", "category": "calendar"},
    {"key": Permissions.CALENDAR_WRITE, "name": "Create & Manage Calendar Events", "category": "calendar"},
    {"key": Permissions.STAFFING_READ, "name": "Read Staffing Sessions", "category": "staffing"},
    {"key": Permissions.STAFFING_CREATE, "name": "Create Staffing Sessions", "category": "staffing"},
    {"key": Permissions.STAFFING_UPDATE, "name": "Update Staffing Reviews", "category": "staffing"},
    {"key": Permissions.STAFFING_COMPLETE, "name": "Complete Staffing Minutes", "category": "staffing"},
    {"key": Permissions.NOTIFICATION_READ, "name": "Read Notifications", "category": "notifications"},
    {
        "key": Permissions.NOTIFICATION_PREFERENCES_UPDATE,
        "name": "Update Notification Preferences",
        "category": "notifications",
    },
    {"key": Permissions.NOTIFICATION_TEMPLATE_READ, "name": "Read Notification Templates", "category": "notifications"},
    {
        "key": Permissions.NOTIFICATION_TEMPLATE_MANAGE,
        "name": "Manage Notification Templates",
        "category": "notifications",
    },
    {
        "key": Permissions.NOTIFICATION_DELIVERY_READ,
        "name": "Read Notification Deliveries",
        "category": "notifications",
    },
    {
        "key": Permissions.NOTIFICATION_DELIVERY_RETRY,
        "name": "Retry Failed Notification Deliveries",
        "category": "notifications",
    },
    # Finance, Billing, Purchase Orders & Invoices (Phase 10)
    {"key": Permissions.FINANCE_REQUEST_READ, "name": "Read Financial Requests", "category": "finance"},
    {"key": Permissions.FINANCE_REQUEST_CREATE, "name": "Create Financial Requests", "category": "finance"},
    {"key": Permissions.FINANCE_REQUEST_UPDATE, "name": "Update Financial Requests", "category": "finance"},
    {"key": Permissions.FINANCE_REQUEST_SUBMIT, "name": "Submit Financial Requests", "category": "finance"},
    {"key": Permissions.FINANCE_REQUEST_APPROVE, "name": "Approve Financial Requests", "category": "finance"},
    {"key": Permissions.FINANCE_REQUEST_RETURN, "name": "Return Financial Requests", "category": "finance"},
    {"key": Permissions.FINANCE_REQUEST_DENY, "name": "Deny Financial Requests", "category": "finance"},
    {"key": Permissions.FINANCE_BUDGET_READ, "name": "Read Budget Lines", "category": "finance"},
    {"key": Permissions.FINANCE_BUDGET_MANAGE, "name": "Manage Budget Lines", "category": "finance"},
    {"key": Permissions.FINANCE_RATE_READ, "name": "Read Billing Rates", "category": "finance"},
    {"key": Permissions.FINANCE_RATE_MANAGE, "name": "Manage Billing Rates", "category": "finance"},
    {"key": Permissions.FINANCE_INVOICE_READ, "name": "Read Invoices", "category": "finance"},
    {"key": Permissions.FINANCE_INVOICE_GENERATE, "name": "Generate Invoices", "category": "finance"},
    {"key": Permissions.FINANCE_INVOICE_REVIEW, "name": "Review Invoices", "category": "finance"},
    {"key": Permissions.FINANCE_INVOICE_FINALIZE, "name": "Finalize Invoices", "category": "finance"},
