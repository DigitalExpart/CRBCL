...
ROLE_PERMISSIONS_MAP = {
    ...
    "director_manager": [
        ...
        Permissions.PLAN_READ, Permissions.PLAN_CREATE, Permissions.PLAN_UPDATE, Permissions.PLAN_DELETE,
        Permissions.PLAN_SUBMIT, Permissions.PLAN_APPROVE, Permissions.PLAN_RETURN, Permissions.PLAN_FINALIZE,
        Permissions.PLAN_LOCK, Permissions.PLAN_UNLOCK, Permissions.PLAN_CLONE, Permissions.PLAN_PRINT,
        Permissions.PLAN_SAFETY_READ, Permissions.PLAN_SAFETY_WRITE, Permissions.PLAN_CASE_READ, Permissions.PLAN_CASE_WRITE,
    ...
    "case_aide": [
        ...
        Permissions.PLAN_READ, Permissions.PLAN_PRINT,
        Permissions.DOCUMENT_READ, Permissions.DOCUMENT_UPLOAD,
        Permissions.TIMELINE_READ,
    ],
    "finance_staff": [
    ...
    "cultural_worker": [
        ...
        Permissions.PLAN_READ, Permissions.PLAN_PRINT, Permissions.PLAN_SIGNATURE_READ, Permissions.PLAN_SIGNATURE_CAPTURE,
        Permissions.DOCUMENT_READ, Permissions.DOCUMENT_UPLOAD,
        Permissions.TIMELINE_READ,
    ],
    "clinical_staff": [
        ...
        Permissions.ASSESSMENT_PRINT, Permissions.ASSESSMENT_COMPARE,
        Permissions.ASSESSMENT_THREAT_READ, Permissions.ASSESSMENT_THREAT_WRITE,
        Permissions.PLAN_READ, Permissions.PLAN_CREATE, Permissions.PLAN_UPDATE, Permissions.PLAN_FINALIZE,
        Permissions.PLAN_PRINT, Permissions.PLAN_SAFETY_READ, Permissions.PLAN_SAFETY_WRITE,
        Permissions.PLAN_GOAL_CREATE, Permissions.PLAN_GOAL_UPDATE, Permissions.PLAN_GOAL_COMPLETE,
        Permissions.PLAN_ACTIVITY_CREATE, Permissions.PLAN_ACTIVITY_UPDATE, Permissions.PLAN_ACTIVITY_COMPLETE,
        Permissions.PLAN_SIGNATURE_READ, Permissions.PLAN_SIGNATURE_CAPTURE,
        Permissions.DOCUMENT_READ, Permissions.DOCUMENT_UPLOAD,
