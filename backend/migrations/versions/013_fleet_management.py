...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "current_driver_id", UUID(as_uuid=True), sa.ForeignKey("users.id", ondelete="SET NULL"), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column("id", UUID(as_uuid=True), primary_key=True),
        sa.Column(
            "geofence_id", UUID(as_uuid=True), sa.ForeignKey("fleet_geofences.id", ondelete="CASCADE"), nullable=False
        ),
        sa.Column("vehicle_id", UUID(as_uuid=True), sa.ForeignKey("vehicles.id", ondelete="CASCADE"), nullable=False),
