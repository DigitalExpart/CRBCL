                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            ...
                            {p.client_approval_status === "APPROVED" && (
                              <Badge variant="outline" className="text-xs bg-emerald-500/10 text-emerald-700 dark:text-emerald-300 border-emerald-500/30 font-medium">
                                Approved Client
                              </Badge>
                            )}
                            {p.client_approval_status === "PENDING_APPROVAL" && (
                              <Badge variant="outline" className="text-xs bg-amber-500/10 text-amber-700 dark:text-amber-300 border-amber-500/30 font-medium">
                                Pending Client
                              </Badge>
                            )}
                            {p.preferred_name && (
